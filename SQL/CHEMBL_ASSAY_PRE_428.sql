CREATE OR REPLACE VIEW CHEMBL_ASSAY_PRE AS
SELECT
...
where
    ...
    and ((a.pchembl_value is not null) or ((a.standard_type = 'Efficacy') and (a.stand_value is not null)) or  (a.standard_relation = '>')  );
